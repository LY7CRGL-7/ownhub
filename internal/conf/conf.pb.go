...
type App struct {
	...
	UploadDir           string                 `protobuf:"bytes,5,opt,name=upload_dir,json=uploadDir,proto3" json:"upload_dir,omitempty"`
	GithubWebhookSecret string                 `protobuf:"bytes,6,opt,name=github_webhook_secret,json=githubWebhookSecret,proto3" json:"github_webhook_secret,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *App) GetPublicBaseUrl() string {
	if x != nil {
...
func (x *App) GetJwtSecret() string {
	if x != nil {
		return x.JwtSecret
	}
	return ""
...
func (x *App) GetUploadDir() string {
	if x != nil {
		return x.UploadDir
	}
	return ""
...
func (x *App) GetGithubWebhookSecret() string {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xaa\x03\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x1a\x86\x01\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12$\n" +
	"\x0emax_open_conns\x18\x03 \x01(\x05R\fmaxOpenConns\x12$\n" +
	"\x0emax_idle_conns\x18\x04 \x01(\x05R\fmaxIdleConns\x1a\xb3\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12<\n" +
	"\fread_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\xc5\x01\n" +
	"\x03App\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03env\x18\x02 \x01(\tR\x03env\x12&\n" +
	"\x0fpublic_base_url\x18\x03 \x01(\tR\rpublicBaseUrl\x12\x1d\n" +
	"\n" +
	"jwt_secret\x18\x04 \x01(\tR\tjwtSecret\x12\x1d\n" +
	"\n" +
	"upload_dir\x18\x05 \x01(\tR\tuploadDir\x122\n" +
	"\x15github_webhook_secret\x18\x06 \x01(\tR\x13githubWebhookSecretB\x1bZ\x19ownhub/internal/conf;confb\x06proto3"
